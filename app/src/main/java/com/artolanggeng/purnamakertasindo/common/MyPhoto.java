...
{
	private static String TAG = "[MyPhoto]";
	...
	public MyPhoto(Context context, Activity activity, int intPekerjaanID, String strPemasokID)
	{
...
//				ProsesUploadPhoto(FileProfile, strNamaFile, warehouse);
	...
	private void ProsesUploadPhoto(File FileProfile, String strNamaFile, String warehouse)
	{
		...
		MultipartBody.Part Namafile = MultipartBody.Part.createFormData("MyPhoto", strNamaFile, rbFile);
