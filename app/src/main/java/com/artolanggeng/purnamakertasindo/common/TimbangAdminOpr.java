 ...
 @BindView(R.id.tvPilihTimbangan)
  ...
  protected void onCreate(Bundle savedInstanceState)
  {
    super.onCreate(savedInstanceState);
	  ...
	  setContentView(R.layout.lay_timbang_admin_opr);
  ...
  @OnClick({R.id.rlTimbangBesar, R.id.rlTimbangKecil, R.id.rlPelangganBaru, R.id.rlPrinter, R.id.rlKeluar,
            R.id.rlProfile, R.id.rlPassword, R.id.rlJualBarang})
  public void onViewClicked(View view)
  {
    switch(view.getId())
    {
      ...
      break;
      case R.id.rlPrinter:
        Intent PrinterIntent = new Intent(TimbangAdminOpr.this, Printer.class);
