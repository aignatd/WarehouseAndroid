...
public class FormPenjualan extends AppCompatActivity
{
	...
	{
		TambahArmada tambahArmada = new TambahArmada(FormPenjualan.this);
	...
	{
		Intent LoginIntent = new Intent(FormPenjualan.this, MainProses.class);
